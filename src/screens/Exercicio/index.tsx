...
import { firestore, collection, query, getDocs, getDoc, doc, where, startAt } from '../../database/firebase';
...
export function Exercicio({ navigation, route }) {
    ...
    const list = async () => {
        try {
            const exercicioRef = collection(firestore, "exercicio");
            const q = query(exercicioRef);
